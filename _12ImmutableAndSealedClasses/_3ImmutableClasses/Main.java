package _12ImmutableAndSealedClasses._3ImmutableClasses;

public class Main {

    public static void main(String[] args) {
        // these lines of code are commented out bcoz we are using contructor to intialize the fields of the Person Class and also removed the setters and getters from the Person Class.
