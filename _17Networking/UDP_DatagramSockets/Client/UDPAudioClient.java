package _17Networking.UDP_DatagramSockets.Client;
...
public class UDPAudioClient {
    private static final int SERVER_PORT = 4994;
    private static final int PACKET_SIZE = 1024;

    public static void main(String[] args) {
        try(DatagramSocket clientSocket = new DatagramSocket()) {

            byte[] audioFileName = "_17Networking/UDP_DatagramSockets/AudioClip.wav".getBytes();
