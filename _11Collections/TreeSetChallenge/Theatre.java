package _11Collections.TreeSetChallenge;
...
public class Theatre {
    ...
    private NavigableSet<Seat> seats; // if we use LinkedHashSet or HashSet we would have to replace NavigableSet with Set

    public Theatre(String theatreName, int rows, int totalSeats) {
        this.theatreName = theatreName;
        this.seatsPerRow = totalSeats / rows;

        seats = new TreeSet<>(); // LinkedHashSet would have generated the same output as TreeSet but HashSet will generate different output
