package _11Collections._4HashSet;
...
public class Contact {
    ...
    private String name;
    private Set<String> emails = new HashSet<>(); // here HashSet is a class that implements Set interface.
    ...
    public void addEmail(String companyName) {
        ...
        String email = "%c%s@%s.com".formatted(name.charAt(0), names[names.length - 1],
                companyName.replaceAll(" ", "").toLowerCase()); // here we are removing spaces from company name, and converting it to lowercase.
        if (!emails.add(email)) {
