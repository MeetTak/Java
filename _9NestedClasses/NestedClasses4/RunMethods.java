package _9NestedClasses.NestedClasses4;

import _9NestedClasses.NestedClasses4.domain.Employee;
import _9NestedClasses.NestedClasses4.domain.EmployeeComparator;
import _9NestedClasses.NestedClasses4.domain.StoreEmployee;
...
public class RunMethods {
    ...
    public static void main(String[] args) {
        ...
        var c2 = new StoreEmployee().new StoreComparator<StoreEmployee>(); // here instance of the StoreEmployee is created first then the instance of the class is created
        ...
        sortIt(storeEmployees, (o1, o2) -> o1.getName().compareTo(o2.getName())); // lamda expressions
    }
...
//Sorting with Comparator: _9NestedClasses.NestedClasses4.domain.StoreEmployee$StoreComparator@396a51ab
...
// nested classes are being represented just after the $ sign
