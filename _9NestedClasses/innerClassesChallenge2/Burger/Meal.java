package _9NestedClasses.innerClassesChallenge2.Burger;
...
public class Meal {
    ...
    private class Burger extends Item {
        ...
        private enum Extra {AVOCADO, BACON, CHEESE, KETCHUP, MAYO, MUSTARD, PICKLES; // use semicolon in enum if you are adding an extra method to it.
